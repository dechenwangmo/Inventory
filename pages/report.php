...
$ims_sql = "SELECT DISTINCT case_no FROM ims";
            ...
            <div class="row" style="padding: 0 25% 0 10%">      
                <div class="col-lg-8" style="float: right;">
                    ...
                    <div class="form-group">
                        <label>Case No.</label>
                       <select name="case_no" class="select form-control">
                            <option value="all"> All </option>
                        <?php foreach($case_no as $case_no) { ?>
                            <option value="<?php echo $case_no; ?>"><?php echo $case_no; ?></option>
                        <?php } ?>
                        </select>
                    </div>
