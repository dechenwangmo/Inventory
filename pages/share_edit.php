...
include('connection.php');
	...
	if(isset($_POST['submit']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE shares 
									     SET 
										     name=:uname,
										     no_of_shares=:uno_of_shares, 
										     share_value=:ushare_value,
										     company=:ucompany,
										     status=:ustatus,
			...
			$stmt->bindParam(':uno_of_shares',$no_of_shares);
			$stmt->bindParam(':ushare_value',$share_value);
...
<body>
		...
		<?php
		  ...
		  <h3 align="center" class="page-header">Edit Shares and Stocks Details</h3>
			<form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
	            ...
	            <div class="row">
	                ...
	                <div class="col-md-6 form-group">
	                    ...
	                    <label class="control-label col-md-4" for="no_of_shares">No of Shares or Stocks</label>
	                    <div class="col-md-8">
	                     <input type="text" class="form-control" name="no_of_shares" value="<?php echo $no_of_shares; ?>"> <br>
	                    </div>
	               
	                    <label class="control-label col-md-4" for="share_value">Share Value </label>
	                    <div class="col-md-8">
	                      <input type="text" class="form-control" name="share_value"  value="<?php echo $share_value; ?>"> <br>
	                    </div>
	                
	                    <label class="control-label col-md-4" for="company">Issuing Company</label>
	                    <div class="col-md-8">
	                      <input type="text" class="form-control" name="company"  value="<?php echo $company; ?>"> <br>
	                    </div>
