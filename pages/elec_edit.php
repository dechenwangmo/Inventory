...
include('connection.php');
	...
	if(isset($_GET['elec_id']) && !empty($_GET['elec_id']))
	{
		$id = $_GET['elec_id'];
		$stmt_edit = $DB_con->prepare('SELECT * FROM electronics WHERE elec_id =:uid');
	...
	if(isset($_POST['submit']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE electronics 
									     SET type=:utype, 
										     model=:umodel,
...
<body>
	...
	<div class="container">
		  ...
		  <h3 align="center" class="page-header">Edit Electronics Items</h3> <br>
	            ...
	            <div class="row">
	                ...
	                <div class="col-md-8 form-group">
	                   ...
	                   <label class="control-label col-md-4" for="serial_no">Serial No.</label>
	                    ...
	                    <label class="control-label col-md-4" for="capacity">Capacity</label>
	                    <div class="col-md-6">
	                      <input type="text" class="form-control" name="capacity"  value="<?php echo $capacity; ?>"> <br>
	                    </div>
