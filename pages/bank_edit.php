...
include('connection.php');
	...
	if(isset($_POST['submit']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE bank
									     SET 
...
<body>
		...
		<?php
		  ...
		  <h3 align="center" class="page-header">Edit Cash In Bank  Detail</h3>
			<form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
	            ...
	            <div class="row">
	                ...
	                <div class="col-md-8 form-group">
	                    ...
	                    <div class="col-md-6">
	                      <input type="text" class="form-control" name="b_add"  value="<?php echo $b_add; ?>"> <br>
	                    </div>
