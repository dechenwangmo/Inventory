...
include('connection.php');
	...
	if(isset($_POST['submit']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE emails 
									     SET 
			...
			$stmt->bindParam(':uemail_add',$email_add);
			$stmt->bindParam(':upwd',$pwd);
			$stmt->bindParam(':ure_pwd',$re_pwd);
...
<body>
		...
		<?php
		  ...
		  <h3 align="center" class="page-header">Edit Email Details</h3>
			<form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
	            ...
	            <div class="row">
	                ...
	                <div class="col-md-8 form-group">
	                    ...
	                    <div class="col-md-6">
	                      <input type="text" class="form-control" name="email_add" value="<?php echo $email_add; ?>"> <br>
	                    </div>
	                
	                    <label class="control-label col-md-4" for="pwd">Password </label>
	                    <div class="col-md-6">
	                      <input type="text" class="form-control" name="pwd"  value="<?php echo $pwd; ?>"> <br>
	                    </div>
	               
	                    <label class="control-label col-md-4" for="re_pwd"> Reset Password</label>
	                    <div class="col-md-6">
	                      <input type="text" class="form-control" name="re_pwd"  value="<?php echo $re_pwd; ?>"> <br>
	                    </div>
