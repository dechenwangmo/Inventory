...
include('connection.php');
	...
	if(isset($_GET['jew_id']) && !empty($_GET['jew_id']))
	{
		$id = $_GET['jew_id'];
		$stmt_edit = $DB_con->prepare('SELECT * FROM jewleries WHERE jew_id =:uid');
	...
	else
	{
		...
		if(isset($_POST['submit']))
		{
			...
			if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE jewleries 
									     SET jew_type=:ujew_type,
									     	 material=:umaterial,
			...
			$stmt->bindParam(':ujew_type', $jew_type);
			$stmt->bindParam(':umaterial',$material);
...
<body>
		...
		<?php
              ...
              <?php } ?>
		  <h3 align="center" class="page-header">Edit Jewelry Items</h3> <br>
			<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" value="<?php echo $ims_id; ?>" name="ims_id">
                    <div class="col-md-8 form-group">
                        <label class="control-label col-md-4" for="jew_type">Jewelries Type</label>
                        <div class="col-md-6">
                          <input type="text" class="form-control" name="jew_type" value="<?php echo $jew_type; ?>"> <br>
                        </div>

                        <label class="control-label col-md-4" for="material">Material</label>
                        <div class="col-md-6">
                          <input type="text" class="form-control" name="material" value="<?php echo $material; ?>"> <br>
                        </div>
                        ...
                        <label class="control-label col-md-4" for="jew_img"></label>
		                    <div class="col-md-4">
