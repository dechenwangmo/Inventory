<?php
 ...
 if(isset($_POST['btnsave']))
	{
 	$errMSG = null;
	$email_add = mysqli_real_escape_string($link, $_POST['email_add']);
	$pwd = mysqli_real_escape_string($link, $_POST['pwd']);
	$re_pwd = mysqli_real_escape_string($link, $_POST['re_pwd']);
...
// 		 	}
		...
		if($errMSG == null)
		{
			$sql = "INSERT INTO emails ( email_add, pwd, re_pwd, status, date_time, to_whom, by_whom, witness,userPic, seizure_id)
         VALUES ('$email_add', '$pwd', '$re_pwd', '$status', '$date_time', '$to_whom', '$by_whom', '$witness', '$userpic', '$seizure_id')" ;
