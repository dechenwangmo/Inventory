...
include('connection.php');
	...
	if(isset($_POST['submit']))
	{
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE document 
									     SET 
										     doc_type=:udoc_type,
										     no_of_pages=:uno_of_pages, 
										     remarks=:uremarks,
											 location=:ulocation,
										     status=:ustatus,
			...
			$stmt->bindParam(':udoc_type',$doc_type);
			$stmt->bindParam(':uno_of_pages',$no_of_pages);
...
<body>
		...
		<?php
		  ...
		  <h3 align="center" class="page-header">Edit Document Items</h3>
			<form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data">
	            ...
	            <div class="row">
	                ...
	                <div class="col-md-8 form-group">
	                    ...
	                    <div class="col-md-6">
	                      <input type="text" class="form-control" name="doc_type" value="<?php echo $doc_type; ?>"> <br>
	                    </div>
	              
	                
	                    <label class="control-label col-md-4" for="no_of_pages">No of Pages</label>
	                    <div class="col-md-6">
	                     <input type="text" class="form-control" name="no_of_pages" value="<?php echo $no_of_pages; ?>"> <br>
	                    </div>
	               
	                    <label class="control-label col-md-4" for="remarks">Remarks </label>
	                    <div class="col-md-6">
	                      <input type="text" class="form-control" name="remarks"  value="<?php echo $remarks; ?>"> <br>
	                    </div>
