...
$jew_type = mysqli_real_escape_string($link, $_POST['jew_type']);
...
$sql = "INSERT INTO jewleries ( jew_type, material, description, location, status, date_time, to_whom, by_whom, witness, userPic, seizure_id) 
VALUES ('$jew_type', '$material', '$description', '$location', '$status', '$date_time', '$to_whom', '$by_whom', '$witness', '$userpic', '$seizure_id')" ;
/*
