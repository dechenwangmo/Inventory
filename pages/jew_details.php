...
<body>
		<div class="container">
		  ...
		  <h3 align="center" class="page-header"> Jewelry Details</h3> <br>
			<form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" value="<?php echo $ims_id; ?>" name="ims_id">
                    <div class="col-md-8 form-group">
                        ...
                        <div class="col-md-6">
                          <input type="text" class="form-control" name="jew_type" value="<?php echo $jew_type; ?>" readonly> <br>
                        </div>
                    
                        <label class="control-label col-md-4" for="material">Material</label>
                        <div class="col-md-6">
                          <input type="text" class="form-control" name="material" value="<?php echo $material; ?>" readonly> <br>
                        </div>
                      ...
                      <label class="control-label col-md-4" for="location"> Storage Location</label>
                        ...
                        <div class="col-md-6">
                          <textarea class="form-control" rows="5" name="description" readonly><?php echo $description; ?></textarea> <br>
                        </div>
