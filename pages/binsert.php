<?php
 ...
 if(isset($_POST['btnsave']))
	...
	$b_add = mysqli_real_escape_string($link, $_POST['b_add']);
	...
	$ims_id = mysqli_real_escape_string($link, $_POST['ims_id']);
		...
		$sql = "INSERT INTO bank (bank_name, acc_no, acc_holder_name, tot_amt, b_add, status, date_time, to_whom, by_whom, witness, userPic, seizure_id) 
VALUES ('$bank_name', '$acc_no', '$acc_holder_name', '$tot_amt', '$b_add', '$status', '$date_time', '$to_whom', '$by_whom', '$witness', '$userpic',  '$seizure_id')";
