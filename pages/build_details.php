...
<body>
  ...
  <div class="container">
      ...
      <h3 align="center" class="page-header">Building Items Details</h3> <br>
    ...
    <div class="row">
        ...
        <div class="col-md-8 form-group">
          <label class="control-label col-md-4" for="address">Building Address</label>
            ...
            <textarea class="form-control" rows="5" name="address" readonly ><?php echo $address; ?></textarea> <br>
            </div>
            <label class="control-label col-md-4" for="description">Description</label>
             ...
             <label class="control-label col-md-4" for="freeze_order">Freeze Order </label>
                <div class="col-md-6">
                 <?php $f = $freeze_order; ?>
                <input type="radio" name="freeze_order" value="Yes" id="show" <?php if($f == 'Yes') { ?> checked="checked" <?php } ?> disabled > Yes
                <input type="radio" name="freeze_order" value="No" id="hide" <?php if($f == 'No') { ?> checked="checked" <?php } ?>  disabled > No
