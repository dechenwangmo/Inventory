...
include('connection.php');
	...
	else
	{
		...
		if(isset($_POST['submit']))
		{
			...
			if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare('UPDATE land 
									     SET land_type=:uland_type,
									     	 area=:uarea,
									     	 thram_no=:uthram_no,
									     	 house_no=:uhouse_no,
									     	 location=:ulocation,
									     	 ...
									     	 userPic=:upic
									         WHERE land_id=:uid');
			$stmt->bindParam(':uland_type',$land_type);
			$stmt->bindParam(':uarea',$area);
			$stmt->bindParam(':uthram_no',$thram_no);
...
<body>
		...
		<?php
		  ...
		  <h3 align="center" class="page-header">Edit Land Items</h3> 
			 ...
			 <?php
	            ...
	            <div class="row">
	                ...
	                <div class="col-md-8 form-group">
	                    ...
	                    <div class="col-md-6">
	                      <input type="text" class="form-control" name="land_type" value="<?php echo $land_type; ?>"> <br>
	                    </div>

	                     <label class="control-label col-md-4" for="area">area</label>
	                    <div class="col-md-6">
	                      <input type="text" class="form-control" name="area" value="<?php echo $area; ?>"><br>
	                    </div>

	                   
	                     <label class="control-label col-md-4" for="thram_no">thram_no</label>
	                    <div class="col-md-6">
	                      <input type="text" class="form-control" name="thram_no" value="<?php echo $thram_no; ?>"><br>
	                    </div>
	                    ...
	                    <div class="col-md-6">
	                     ...
	                     <label class="control-label col-md-4" for="freeze_order">Freeze Order</label>
	                        <div class="col-md-6">
	                         <?php $f = $freeze_order; ?>
	                              <input type="radio" name="freeze_order" value="Yes" id="land_show" <?php if($f == 'Yes') { ?> checked="checked" <?php } ?> > Yes
	                              <input type="radio" name="freeze_order" value="No" id="land_hide" <?php if($f == 'No') { ?> checked="checked" <?php } ?> > No 
	                              
	                              <div id="freeze_order_ref" <?php if($f == 'No') { ?> style="display:none;" <?php } ?> >
	                                 <input type="text" class="form-control" name="freeze_order_ref"  value="<?php echo $freeze_order_ref; ?>">
	                              </div>
